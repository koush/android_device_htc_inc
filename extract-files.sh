...
# Revision 1 - This needs to be removed once .32 kernel is ported.
# Revision 2 - I added code into the kernel and bionic to support PMEM_CACHE_FLUSH.
# so this may no longer be necessary
#adb pull /system/lib/hw/gralloc.qsd8k.so ../../../vendor/htc/$DEVICE/proprietary

# Bluetooth hacks
adb pull /system/lib/libbluetooth.so ../../../vendor/htc/$DEVICE/proprietary
adb pull /system/lib/libbluetoothd.so ../../../vendor/htc/$DEVICE/proprietary
adb pull /system/lib/libbluedroid.so ../../../vendor/htc/$DEVICE/proprietary
